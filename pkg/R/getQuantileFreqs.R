...
getQuantileFreqs <- function(scores,grp1,grp2) {
    ...
    if(any(is.na(scores))) {
        stop("\nMissing values are present in the scores data. Missing values can be present in the raw expression data fed to getQuantileScores, but not here. If your data was generated by getQuantileScores, and you get this message, this is a bug. Please contact the QuantCombine package maintainer. If you see values of -1000 in the the scores data generated by getQuantileScores, this is okay. These values were missing in the original expression data, and are ignored by getQuantileFreqs.\n\n")
    }
    ...
    labels.range <- range(scores[1,(scores[1,]>-1000)]) #each gene will always have a max and min value
